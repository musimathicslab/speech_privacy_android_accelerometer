...
directory = ['DatasetVocali/DatasetA', 'DatasetVocali/DatasetE', 'DatasetVocali/DatasetI', 'DatasetVocali/DatasetO',
             'DatasetVocali/DatasetU']
